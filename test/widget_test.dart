...
import 'package:vitafolio/features/resume/domain/repositories/resume_repository.dart' as domain;
import 'package:vitafolio/features/resume/presentation/providers/resume_domain_providers.dart';

class FakeDomainResumeRepository implements domain.ResumeRepository {
  @override
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          ...
          cleanResumeRepositoryProvider.overrideWithValue(FakeDomainResumeRepository()),
        ],
        child: const App(),
      ),
    );
