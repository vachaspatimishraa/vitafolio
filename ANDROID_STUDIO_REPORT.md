...
- `EducationListPage`: The main screen for managing educational qualifications.
- `EducationCard`: Displays individual education records with an integrated options menu.

### Reusable Widgets

#### Widgets Reused

- `EmptyState` (`lib/shared/widgets/empty_states/empty_state.dart`)
- `ResumeProgressStepper` (`lib/shared/widgets/helpers/resume_progress_stepper.dart`)
- `StickyBottomNavigation` (`lib/shared/widgets/helpers/sticky_bottom_navigation.dart`)
